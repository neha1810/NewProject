        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-md-12 col-sm-12 col-xs-12 col-lg-3 pt-5" id="my-filter">
              ...
              <p className="prodFont">Amazon</p> <Input type="checkbox" className="vendor" name="amazon" value="amazon" onchange={this.handlecheck} />
              <p className="prodFont">Myntra</p> <Input type="checkbox" className="vendor" name="Myntra" value="myntra" onchange={this.handlecheck} />
              <div>
