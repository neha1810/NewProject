...
class CategoryTravel extends React.Component {
        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-md-12 col-sm-12 col-xs-12 col-lg-3 pt-5" id="my-filter">
              ...
              <p className="prodFont">MakeMyTrip</p> <Input type="checkbox" className="vendor" name="MakeMytrip" value="MakeMytrip" onchange={this.handlecheck} />
              <p className="prodFont">Tripadvisor</p><Input type="checkbox" className="vendor" name="Tripadvisor" value="Tripadvisor" onchange={this.handlecheck} />
              <div>
