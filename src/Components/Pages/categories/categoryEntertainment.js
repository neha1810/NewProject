        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-md-12 col-sm-12 col-xs-12 col-lg-3 pt-5" id="my-filter">
              ...
              <p className="prodFont">BookmyShow</p> <Input type="checkbox" className="vendor" name="BookmyShow" value="BookmyShow" onchange={this.handlecheck} />
              <p className="prodFont">Saavn</p> <Input type="checkbox" className="vendor" name="Saavn" value="Saavn" onchange={this.handlecheck} />
              <div>
