        ...
        <div className="container-fluid">
          ...
          <div className="row">
            ...
            <div className="col-md-12 col-sm-12 col-xs-12 col-lg-3 pt-5" id="my-filter">
              ...
              <p className="prodFont">KFC</p> <Input type="checkbox" className="vendor" name="KFC" value="KFC" onchange={this.handlecheck} />
              <p className="prodFont">McDonald</p><Input type="checkbox" className="vendor" name="McDonald" value="McDonald" onchange={this.handlecheck} />
              <div>
